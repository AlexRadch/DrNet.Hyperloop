...
namespace DrNet.Hyperloop.BenchmarkTests
{
    ...
    public class HyperloopBenchmarks
    {
        ...
        protected IEnumerable<int> RecursiveRangeHl_Impl(HyperloopRecursions<int> recursion, int start, int count)
        {
            if (count <= 1)
            {
                if (count == 1)
        ...
        protected IEnumerable<int> RecursiveRangeHl_TailOptimization_Impl(HyperloopRecursions<int> recursion, int start, int count)
        {
            if (count <= 1)
            {
                if (count == 1)
        ...
        protected IEnumerable<int> RecursiveRangeHl_OrderOptimization_Impl(HyperloopRecursions<int> recursion, int start, int count)
        {
            if (count <= 1)
            {
                if (count == 1)
        ...
        protected IEnumerable<int> RecursiveRangeHl_TailOrderOptimization_Impl(HyperloopRecursions<int> recursion, int start, int count)
        {
            if (count <= 1)
            {
                if (count == 1)
